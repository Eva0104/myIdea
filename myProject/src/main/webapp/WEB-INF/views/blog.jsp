...
<div class="blog-masthead">
    <div class="container">
        <nav class="blog-nav">
            ...
            <a class="blog-nav-item" href="#">查询</a>
            <a class="blog-nav-item" href="#">收款</a>
                    ...
                    <table class="table">
                        ...
                        <c:forEach items="${client}" var="client">
                            <tr>
                                ...
                                <td>${client.card}</td>
                                <td>${client.baby}</td>
                                <td>${client.babyMum}</td>
                                <td>${client.money}</td>
                                <td>${client.types}</td>
                                <td>
                                    <button class="btn btn-success btn-xs">充值</button>
                                    <button class="btn btn-success btn-xs">消费</button>
                                </td>
                            </tr>
                        </c:forEach>
                        </tbody>
